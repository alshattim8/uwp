...
// Processes the transactions and displays the results in a table format.
// The function requests the transaction number and weight outputing the 
// correct cost or an error message if the weight violates any
// restrictions.
// params: 
// Author: John W Hunter
