...
/**
The BigFigure class draws and controls the movement of
the big figure in the game.
It extends PFigure.
@author John Hunter
@author Andre Fugere
*/

public class BigFigure extends PFigure
{
   ...
   */
   public BigFigure(Panel pan)
   {
      super(pan.getSize().width - 100, pan.getSize().height - 100, 100, 100,
            0, pan);
      this.deltaX = delta;
      this.deltaY = delta;
      try
       {
          File file = new File("051Dugtrio.png");
   ...
   */
   ...
   /**
   The move method controls the movement of the big enemy through a random
   number generator. 
   */
   @Override
   public void move()
